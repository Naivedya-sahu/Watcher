...
// ============================================================
// Bitmap Font — 6×8 pixels per glyph
// Matches design spec: Monocraft-compatible monospace pixel font
// Placeholder until Monocraft.otf is converted to bitmap.
//
// Encoding: each glyph = 6 bytes, one byte per column (0=left)
// Within each byte: bit 0 = top pixel (LSB=top), bit 7 = bottom pixel
// ASCII 0x20 (space) through 0x7E (~), 95 characters
// ============================================================

#define FONT_W  6   // glyph width (includes 1px right padding)
#define FONT_H  8   // glyph height

// Compact 6×8 monospace bitmap font — ASCII 0x20–0x7E
// Generated from classic 5×7 pixel font, padded to 6×8
static const uint8_t FONT_MONO6[][6] = {
