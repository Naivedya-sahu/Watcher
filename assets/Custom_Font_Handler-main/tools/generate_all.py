...
Automatically converts all TTF/OTF fonts in input/ directory to C bitmap arrays
Generates standard sizes: 12, 14, 16, 18, 20, 24, 28, 32px
Output organized by font name
...
def main():
    ...
    print()
    print("Next steps:")
    print("  1. Browse output/ subdirectories")
    print("  2. Copy desired .cpp and .h files to Arduino project")
    print("  3. Update fonts.h with extern declarations")
    print("  4. Use in your sketch")
