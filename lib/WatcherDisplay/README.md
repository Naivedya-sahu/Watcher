...
### New Features: Custom Fonts & Geometric Shapes

**Custom Font Support** - Use any TTF/OTF font on your display!

```cpp
// Include custom fonts (generated by font_generator.py)
...
**Geometric Shapes** - Rich set of drawing primitives:
...
- [CUSTOM_FONTS_GUIDE.md](CUSTOM_FONTS_GUIDE.md) - Complete font integration tutorial
- [GEOMETRIC_SHAPES_GUIDE.md](GEOMETRIC_SHAPES_GUIDE.md) - All shape functions with examples
