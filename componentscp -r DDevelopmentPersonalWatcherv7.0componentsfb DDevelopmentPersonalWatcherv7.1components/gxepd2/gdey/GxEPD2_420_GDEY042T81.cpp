...
static const char *TAG = "gxepd2_420";
...
{
  (void)pgm;
  _writeImage(0x24, bitmap, x, y, w, h, invert, mirror_y, false);
}
...
{
  (void)pgm;
  _writeImage(0x26, bitmap, x, y, w, h, invert, mirror_y, false);
  _writeImage(0x24, bitmap, x, y, w, h, invert, mirror_y, false);
}
...
{
  (void)pgm;
  _writeImagePart(0x24, bitmap, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h, invert, mirror_y, false);
}
    ...
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  (void)pgm;
  _writeImagePart(0x24, bitmap, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h, invert, mirror_y, false);
  _writeImagePart(0x26, bitmap, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h, invert, mirror_y, false);
}
